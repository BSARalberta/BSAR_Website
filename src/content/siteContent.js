...
export const transparencyContent = {
  events: {
    eyebrow: 'Events',
    title: 'Upcoming events and community engagements',
    description:
      'Stay informed about upcoming public events and community outreach. This is where you can find ways to engage with our team, learn about search and rescue, and get involved in community safety.',
    items: [
      {
        title: 'Community event listing placeholder',
        description:
          'Use this card for a future public event such as a community safety day, demonstration, fundraiser, or outreach appearance.',
        meta: 'Future public event',
      },
      {
        title: 'Training or awareness session placeholder',
        description:
          'This space can support public notices for awareness sessions, presentations, or approved training-related events open to the community.',
        meta: 'Future awareness update',
      },
    ],
  },
  agm: {
    eyebrow: 'AGM Announcement',
    title: 'Annual general meeting notices',
    description:
      'Find information about our Annual General Meetings. These meetings help keep our community informed about our operations, decisions, and ongoing efforts.',
    items: [
      {
        title: 'Annual general meeting notice placeholder',
        description:
          'Publish the AGM date, time, location, attendance instructions, and any participation notes here when they are confirmed.',
        meta: 'Future AGM notice',
      },
      {
        title: 'AGM summary or agenda placeholder',
        description:
          'Use this card for a future AGM agenda, notice package, meeting summary, or post-meeting public update.',
        meta: 'Future AGM update',
      },
    ],
  },
}
