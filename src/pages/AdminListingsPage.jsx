          ...
          <article className="content-card">
            <div className="content-card-body">
              ...
              <p>
                ...
                enable the admin interface and live public listings.
              </p>
            </div>
          </article>
        </div>
    ...
    <section className="section">
      <div className="container admin-layout">
        <div className="admin-intro">
          ...
          <h1>Manage events and AGMs</h1>
          <p>
            Sign in with a Supabase Auth user that is allowed by your RLS policies, then
            publish upcoming public events and AGM notices from one shared system.
          </p>
        </div>
          ...
          <div className="admin-shell">
            <div className="admin-toolbar">
              <p className="muted-note">
                Signed in as {session.user.email || footerContent.contactValue}
              </p>
              ...
              <section className="document-section">
                <div className="document-section-header-wrap">
                  <div className="document-section-header">
                    ...
                    <p>
                      Review current entries, filter by type, and reopen any item for editing.
                    </p>
                  </div>
                ...
                {isLoading ? (
                  ...
                  <article className="content-card">
                    <div className="content-card-body">
                      ...
                      <h3>
                        Create your first {listingTypeView === 'event' ? 'event' : 'AGM'}
                      </h3>
